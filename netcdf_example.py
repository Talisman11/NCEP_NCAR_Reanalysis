...
nc_attrs, nc_dims, nc_vars = ncdump(nc_fid) # output some metadata
...
# ''' Start some data processing'''
# time_idx = 237  # pick random day
...
# # Setup the map. See http://matplotlib.org/basemap/users/mapsetup.html for other projections.
